---
layout: post
title:  "OSED preparation with a different study path - part 1: PE file format & Windbg JS API"
...
## Intro ##
  The following post will introduce PE file format and the Windbg JS API.
