...
The first step should be called information gathering, and as the name suggest is the act of collecting knowledge. Of course you can directly going into the codebase, but personally i prefer spending more time on this part. The step is subdivided in:
